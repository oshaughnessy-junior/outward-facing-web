...
In 2011, I identifed a robust ``corotating frame", a way of choosing time-dependent angular coordinates at large
            distances using only the radiated  signal.  Tested against simulated binary mergers provided by Georgia
            Tech (J. Healy), this frame simplifies the outgoing gravitational wave signal.  Mode-by-mode,
   ...
   * permit efficient generation of approximate interpolated or synthetic 'precessing' waveforms, multiplying an
                     interpolated rotation with an interpolated waveform
