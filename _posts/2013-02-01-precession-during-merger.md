...
In our [recent paper](http://adsabs.harvard.edu/abs/2013PhRvD..87d4038O), we re-expressed the gravitational wave signal from simulated binary black hole mergers in this frame.
...
- the corotating-frame signal does not (and cannot) be identical to the signal from nonprecessing
  binaries. For example, corotating-frame modes generically have modulations on a precession timescale.

- the merger of precessing binaries coherently excites quasinormal modes, which "precess" around
  the total angular momentum direction. We speculate the details of this process provide a signature
  of strong-field gravity.

For more information, see

Our paper: [ROS et al 2013 PRD 87 4038](http://adsabs.harvard.edu/abs/2013PhRvD..87d4038O)

[My talk](http://online.kitp.ucsb.edu/online/chirps_c12/oshaughnessy/) at the 2012 KITP meeting, ["Rattle and Shine: Gravitational Wave and Electromagnetic Studies of Compact Binary Mergers"](http://pctp.princeton.edu/pctp/grav_waves2012/grav_waves2012.html)
