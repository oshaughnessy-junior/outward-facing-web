...
* [ROS et al.,  Parameter Estimation of Gravitational Waves from Precessing BH-NS Inspirals with higher harmonics,   arxiv.org:1403.0554](http://arxiv.org/abs/1403.0544)

* Recent work by [Vitale et al (1403.0554)](http://arxiv.org/abs/1403.0129) uses the same ` lalinference ` codebase

* Recent work by [the Montana State group (1402.3581)](http://arxiv.org/abs/1402.3581) uses a different code and waveform model to assess parameter estimation of low-mass binaries, including double neutron stars.
