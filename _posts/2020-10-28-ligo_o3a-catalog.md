...
- [GWTC-2 catalog](https://dcc.ligo.org/LIGO-P2000061/public), submitted to PRX, with a public data release available at LIGO DCC; see also [the GW open science center](https://www.gw-openscience.org/catalog/).

- [Population properties of compact objects from the second LIGO–Virgo Gravitational-Wave Transient Catalog](https://dcc.ligo.org/LIGO-P2000077/public), with an embedded data release.
...
RIFT and the O3a catalog: Our parameter inference code [RIFT](https://arxiv.org/pdf/1805.10457.pdf) was used to compare gravitational wave observations to the data. Jake's thesis (under embargo until Dec 1) included some of the O3a PE.
