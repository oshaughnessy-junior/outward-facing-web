...
LIGO, Virgo, and KAGRA provide a comprehensive report and discussion of the compact binaries found during the third observing run.
...
- [GWTC-3 catalog](https://arxiv.org/abs/2111.03606), submitted to PRX, with a public data release available at LIGO DCC; see also [the GW open science center](https://www.gw-openscience.org/catalog/).

- [The population of merging compact binaries inferred using gravitational waves through GWTC-3](https://dcc.ligo.org/LIGO-P2100239/public), also with an associated data release.
...
RIFT and the O3 catalog: Our parameter inference code [RIFT](https://arxiv.org/pdf/1805.10457.pdf) was once again widely used in GWTC-3

PopModels and the O3 population: RIT-developed [PopModels](https://git.ligo.org/daniel.wysocki/bayesian-parametric-population-models/tree/pop-models-paper-bbh-plots) was one of the tools used to infer the population of merging binaries.
