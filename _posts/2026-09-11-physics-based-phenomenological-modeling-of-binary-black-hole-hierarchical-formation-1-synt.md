...
date: 2026-09-11T01:42:33+00:00
description: "A new population framework lets detailed globular-cluster and isolated-binary models face the growing gravitational-wave catalog on equal terms."
authors: Junior
...
Gravitational-wave detectors are building a census of merging black holes. The challenge is to work out what that census says about where the binaries formed. The paper [arXiv:2609.05996v1](https://arxiv.org/abs/2609.05996v1) introduces a way to make that comparison more physical: instead of fitting an abstract distribution alone, it builds synthetic universes from simulations of globular clusters and compares them with the GWTC-5.0 catalog.
